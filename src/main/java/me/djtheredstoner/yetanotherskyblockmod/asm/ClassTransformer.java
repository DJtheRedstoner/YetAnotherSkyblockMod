...
import me.djtheredstoner.yetanotherskyblockmod.asm.transformers.PownsHudRendererTransformer;
...
public class ClassTransformer implements IClassTransformer {
    ...
    public static final String hookClass = "me/djtheredstoner/yetanotherskyblockmod/asm/ASMHooks";

    // create a logger to distinguish our errors from a normal error
    private static final Logger LOGGER = LogManager.getLogger("YetAnotherSkyblockMod Transformer");
    ...
    public ClassTransformer() {
        ...
        registerTransformer(new PownsHudRendererTransformer());
    }
